...
update parere_soprintendenza set esito_parere = 'AUT_CON_PRESCRIZ' WHERE esito_parere = 'AUT_PRESCR';
update provvedimento_finale set esito_provvedimento = 'AUT_CON_PRESCRIZ' WHERE esito_provvedimento = 'AUT_PRESCR'; 