update presentazione_istanza.web_content 
set contenuto = '				
...
<br>
<br>
L''istanza può essere compilata in prima persona dal proponente/titolare o potrà nominare un Delegato che sarà l''unico che potrà intervenire sull''istanza
<br>
<br>
<br>
<br>    <b>Sei sicuro di voler procedere?</b>
<br>'
where codice_contenuto = 'NUOVO_FASCICOLO'