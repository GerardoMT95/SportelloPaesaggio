DROP VIEW presentazione_istanza.v_fascicolo_public;
CREATE VIEW presentazione_istanza.v_fascicolo_public
AS SELECT '-1'::integer AS id,
    ...
    pratica.codice_pratica_appptr AS codice_interno_ente,
