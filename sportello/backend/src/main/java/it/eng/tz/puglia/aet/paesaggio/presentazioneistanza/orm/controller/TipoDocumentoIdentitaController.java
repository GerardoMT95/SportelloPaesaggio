...
/**
 * Controller CRUD for table presentazione_istanza.tipo_documento_identita
 */
@Controller
@RequestMapping("TipoDocumentoIdentita")
public class TipoDocumentoIdentitaController extends BaseRestController{

    /**
     * logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(TipoDocumentoIdentitaController.class);
    /**
     * service
     */
    @Autowired
    private ITipoDocumentoIdentitaService service;

    /**
     * select all
     */
    @GetMapping(value="/select.pjson", produces=MEDIA_TYPE)
    public ResponseEntity<BaseRestResponse<List<TipoDocumentoIdentitaDTO>>> select(){
    ...
    public ResponseEntity<BaseRestResponse<TipoDocumentoIdentitaDTO>> find(@RequestBody TipoDocumentoIdentitaDTO pk){
    ...
    public ResponseEntity<BaseRestResponse<PaginatedList<TipoDocumentoIdentitaDTO>>> search(@RequestBody TipoDocumentoIdentitaSearch search){
    ...
    public ResponseEntity<BaseRestResponse<Long>> insert(@RequestBody TipoDocumentoIdentitaDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> update(@RequestBody TipoDocumentoIdentitaDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> delete(@RequestBody TipoDocumentoIdentitaDTO dto){
