...
public class AutPaesPptrLocalizInterv {
	...
	//transiente durante la migrazione appoggio il mio id del comune (quello di common_ente)
	private long localizIntervComuneIdNew;

	
	public long getLocalizIntervComuneIdNew() {
		return localizIntervComuneIdNew;
	}

	public void setLocalizIntervComuneIdNew(long localizIntervComuneIdNew) {
		this.localizIntervComuneIdNew = localizIntervComuneIdNew;
	}
