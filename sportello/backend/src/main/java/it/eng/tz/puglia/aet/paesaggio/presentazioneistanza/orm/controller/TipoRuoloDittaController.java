...
/**
 * Controller CRUD for table presentazione_istanza.tipo_ruolo_ditta
 */
@Controller
@RequestMapping("TipoRuoloDitta")
public class TipoRuoloDittaController extends BaseRestController{

    /**
     * logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(TipoRuoloDittaController.class);
    /**
     * service
     */
    @Autowired
    private ITipoRuoloDittaService service;

    /**
     * select all
     */
    @GetMapping(value="/select.pjson", produces=MEDIA_TYPE)
    public ResponseEntity<BaseRestResponse<List<TipoRuoloDittaDTO>>> select(){
    ...
    public ResponseEntity<BaseRestResponse<TipoRuoloDittaDTO>> find(@RequestBody TipoRuoloDittaDTO pk){
    ...
    public ResponseEntity<BaseRestResponse<PaginatedList<TipoRuoloDittaDTO>>> search(@RequestBody TipoRuoloDittaSearch search){
    ...
    public ResponseEntity<BaseRestResponse<Long>> insert(@RequestBody TipoRuoloDittaDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> update(@RequestBody TipoRuoloDittaDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> delete(@RequestBody TipoRuoloDittaDTO dto){
