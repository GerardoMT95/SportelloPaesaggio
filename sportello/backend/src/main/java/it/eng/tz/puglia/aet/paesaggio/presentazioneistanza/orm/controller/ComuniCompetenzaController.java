...
/**
 * Controller CRUD for table presentazione_istanza.comuni_competenza
 */
@Controller
@RequestMapping("/ComuniCompetenza")
public class ComuniCompetenzaController extends BaseRestController{

    /**
     * logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(ComuniCompetenzaController.class);
    /**
     * service
     */
    @Autowired
    private IComuniCompetenzaService service;

    /**
     * select all
     */
    @GetMapping(value="/select.pjson", produces=MEDIA_TYPE)
    public ResponseEntity<BaseRestResponse<List<ComuniCompetenzaDTO>>> select(){
    ...
    public ResponseEntity<BaseRestResponse<ComuniCompetenzaDTO>> find(@RequestBody ComuniCompetenzaDTO pk){
    ...
    public ResponseEntity<BaseRestResponse<PaginatedList<ComuniCompetenzaDTO>>> search(@RequestBody ComuniCompetenzaSearch search){
    ...
    public ResponseEntity<BaseRestResponse<Long>> insert(@RequestBody ComuniCompetenzaDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> update(@RequestBody ComuniCompetenzaDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> delete(@RequestBody ComuniCompetenzaDTO dto){
