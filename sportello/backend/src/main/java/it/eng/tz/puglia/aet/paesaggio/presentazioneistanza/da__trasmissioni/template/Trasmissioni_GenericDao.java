 ...
 * @date 29 lug 2019
 */
public abstract class Trasmissioni_GenericDao {

	protected final Logger logger = LoggerFactory.getLogger(this.getClass());
	/**
	 * Jdbc template write transaction
	 */
	protected JdbcTemplate jdbcTrasmissioniTemplateWrite;
	/**
	 * Jdbc template read transaction
	 */
	protected JdbcTemplate jdbcTrasmissioniTemplateRead;
	/**
	 * Named jdbc template read
	 */
	@Autowired
	@Qualifier(DatabaseConfiguration.NAMED_JDBC_TEMPLATE_READ)
	protected NamedParameterJdbcTemplate namedJdbcTrasmissioniTemplateRead;
	/**
	 * Named jdbc template write
	 */
	@Autowired
	@Qualifier(DatabaseConfiguration.NAMED_JDBC_TEMPLATE_WRITE)
	protected NamedParameterJdbcTemplate namedJdbcTrasmissioniTemplateWrite;
	/**
	 * Post constructor
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	private void postConstruct() {
		this.jdbcTrasmissioniTemplateWrite = this.namedJdbcTrasmissioniTemplateWrite.getJdbcTemplate();
		this.jdbcTrasmissioniTemplateRead  = this.namedJdbcTrasmissioniTemplateRead .getJdbcTemplate();
	}
	/**
	 * Execute sql
	 * @author Antonio La Gatta
	...
	public void execute(String sql) {
		this.jdbcTrasmissioniTemplateWrite.execute(sql);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public <T> T queryForObject(String sql, Class<T> clazz) { 
		return this.jdbcTrasmissioniTemplateRead.queryForObject(sql, clazz);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public <T> T queryForObject(String sql, Class<T> clazz, Object...args) { 
		return this.jdbcTrasmissioniTemplateRead.queryForObject(sql, clazz, args);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public <T> T queryForObject(String sql, RowMapper<T> rowMapper, Object... args) { 
		return this.jdbcTrasmissioniTemplateRead.queryForObject(sql, rowMapper, args);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public <T> T queryForObject(String sql, RowMapper<T> rowMapper) { 
		return this.jdbcTrasmissioniTemplateRead.queryForObject(sql, rowMapper);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public List<Map<String, Object>> queryForList(String sql) { 
		return this.jdbcTrasmissioniTemplateRead.queryForList(sql);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public <T> List<T> queryForList(String sql, RowMapper<T> rowMapper) {
		return this.jdbcTrasmissioniTemplateRead.query(sql, rowMapper);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public <T> List<T> queryForList(String sql, RowMapper<T> rowMapper, Object... args) {
		return this.jdbcTrasmissioniTemplateRead.query(sql, rowMapper, args);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public <T> List<T> queryForListNamedParameters(String sql, ResultSetExtractor<List<T>> rse, Object... args) {
		return this.jdbcTrasmissioniTemplateRead.query(sql, rse, args);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public List<Map<String, Object>> queryForList(String sql, Object... args) { 
		return this.jdbcTrasmissioniTemplateRead.queryForList(sql, args);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public <T> List<T> queryForList(String sql, Class<T> clazz, Object... args) { 
		return this.jdbcTrasmissioniTemplateRead.queryForList(sql, clazz, args);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public int update(String sql) {
		...
		try {
			return this.jdbcTrasmissioniTemplateWrite.update(sql);
		}finally {
			this.stopWatch(sw);
		}
	}
	...
	public int update(String sql, Object... args) {
		StopWatch sw = this.startWatch("update");
		try {
			return this.jdbcTrasmissioniTemplateWrite.update(sql, args);
		}finally {
			this.stopWatch(sw);
		}
	}
	...
	public <T> T namedQueryForObject(String sql, Class<T> clazz, Map<String,Object> paramMap) { 
		return this.namedJdbcTrasmissioniTemplateRead.queryForObject(sql, paramMap, clazz);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public List<Map<String, Object>> namedQueryForList(String sql, Map<String,Object> paramMap) { 
		return this.namedJdbcTrasmissioniTemplateRead.queryForList(sql, paramMap);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public <T> List<T> namedQueryForList(String sql, RowMapper<T> rowMapper, Map<String,Object> paramMap) {
		return this.namedJdbcTrasmissioniTemplateRead.query(sql, paramMap, rowMapper);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public <T> List<T> namedQueryForListNamedParameters(String sql, ResultSetExtractor<List<T>> rse, Map<String,Object> paramMap) {
		return this.namedJdbcTrasmissioniTemplateRead.query(sql, paramMap, rse);
	}
	/**
	 * @author Antonio La Gatta
	 * @date 29 lug 2019
	...
	public int namedUpdate(String sql, Map<String,Object> paramMap) {
		StopWatch sw = this.startWatch("update");
		try {
			return this.namedJdbcTrasmissioniTemplateWrite.update(sql, paramMap);
		}finally {
			this.stopWatch(sw);
		}
	}
	...
	protected <T> T singleRow(String sql, RowMapper<T> rowMapper, Object[] args){
    	try{
    		return this.jdbcTrasmissioniTemplateRead.queryForObject(sql, args, rowMapper);
