...
import it.eng.tz.puglia.aet.paesaggio.presentazioneistanza.servizi_esterni.protocollo.model.Allegati;
...
public class ProtocolloConfig {
	...
	public Jaxb2Marshaller webServiceMarshaller() {
		...
		marshaller.setPackagesToScan(Allegati.class.getPackageName());
		return marshaller;
	}
	/**
	 * @author Antonio La Gatta
