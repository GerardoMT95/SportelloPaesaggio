...
/**
 * Controller CRUD for table presentazione_istanza.referenti
 */
@Controller
@RequestMapping("/Referenti")
public class ReferentiController extends BaseRestController{

    /**
     * logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(ReferentiController.class);
    /**
     * service
     */
    @Autowired
    private IReferentiService service;

    /**
     * select all
     */
    @GetMapping(value="/select.pjson", produces=MEDIA_TYPE)
    public ResponseEntity<BaseRestResponse<List<ReferentiDTO>>> select(){
    ...
    public ResponseEntity<BaseRestResponse<ReferentiDTO>> find(@RequestBody ReferentiDTO pk){
    ...
    public ResponseEntity<BaseRestResponse<PaginatedList<ReferentiDTO>>> search(@RequestBody ReferentiSearch search){
    ...
    public ResponseEntity<BaseRestResponse<Long>> insert(@RequestBody ReferentiDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> update(@RequestBody ReferentiDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> delete(@RequestBody ReferentiDTO dto){
