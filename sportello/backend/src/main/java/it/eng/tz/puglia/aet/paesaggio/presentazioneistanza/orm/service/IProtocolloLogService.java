...
/**
 * Service interface CRUD for table presentazione_istanza.tipo_ruolo_ditta
 */
public interface IProtocolloLogService extends ICrudService<ProtocolloDTO, ProtocolloSearch, ProtocolloRepository>{
