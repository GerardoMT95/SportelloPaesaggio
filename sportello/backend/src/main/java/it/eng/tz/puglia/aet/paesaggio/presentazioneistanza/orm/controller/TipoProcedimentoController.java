...
/**
 * Controller CRUD for table presentazione_istanza.tipo_procedimento
 */
@Controller
@RequestMapping("TipoProcedimento")
public class TipoProcedimentoController extends BaseRestController{

    /**
     * logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(TipoProcedimentoController.class);
    /**
     * service
     */
    @Autowired
    private ITipoProcedimentoService service;

    /**
     * select all
     */
    @GetMapping(value="/select.pjson", produces=MEDIA_TYPE)
    public ResponseEntity<BaseRestResponse<List<TipoProcedimentoDTO>>> select(){
    ...
    public ResponseEntity<BaseRestResponse<TipoProcedimentoDTO>> find(@RequestBody TipoProcedimentoDTO pk){
    ...
    public ResponseEntity<BaseRestResponse<PaginatedList<TipoProcedimentoDTO>>> search(@RequestBody TipoProcedimentoSearch search){
    ...
    public ResponseEntity<BaseRestResponse<Long>> insert(@RequestBody TipoProcedimentoDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> update(@RequestBody TipoProcedimentoDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> delete(@RequestBody TipoProcedimentoDTO dto){
