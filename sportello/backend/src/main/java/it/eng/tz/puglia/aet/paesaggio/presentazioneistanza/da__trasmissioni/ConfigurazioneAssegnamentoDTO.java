...
public class ConfigurazioneAssegnamentoDTO implements Serializable {
	...
	private List<ValoriAssegnamentoNewDTO> valoriAssegnati;	// non c'è sul DB
	...
	public List<ValoriAssegnamentoNewDTO> getValoriAssegnati() {
		return valoriAssegnati;
	}
	public void setValoriAssegnati(List<ValoriAssegnamentoNewDTO> valoriAssegnati) {
	...
	public String toString() {
		return "ConfigurazioneAssegnamentoDTO [idOrganizzazione=" + idOrganizzazione + ", fase=" + fase + ", rup=" + rup
