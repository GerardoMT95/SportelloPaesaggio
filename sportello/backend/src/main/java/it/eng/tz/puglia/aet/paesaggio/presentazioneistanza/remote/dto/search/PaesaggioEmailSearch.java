 ...
 */
public class PaesaggioEmailSearch extends Trasmissioni_WhereClauseGenerator<Common_Paesaggio_Email>
{
	...
	protected void generateWhereCriteria()
	{
		...
		if (id != null)
		{
			sql.append(separator).append(Common_Paesaggio_Email.id.getCompleteName()).append(" = :")
		...
		{
			sql.append(separator).append(Common_Paesaggio_Email.codice_applicazione.getCompleteName()).append(" = :")
		...
		{
			sql.append(separator).append(Common_Paesaggio_Email.email.getCompleteName()).append(" ILIKE :")
		...
		{
			sql.append(separator).append(Common_Paesaggio_Email.denominazione.getCompleteName()).append(" ILIKE :")
		...
		if (pec != null)
		{
			sql.append(separator).append(Common_Paesaggio_Email.pec.getCompleteName()).append(" = :")
		...
		{
			sql.append(separator).append(Common_Paesaggio_Email.organizzazione_id.getCompleteName()).append(" = :")
					.append(Common_Paesaggio_Email.organizzazione_id.columnName()).append(" and ")
					.append(Common_Paesaggio_Email.ente_id.getCompleteName()).append(" IS NULL");
			parameters.put(Common_Paesaggio_Email.organizzazione_id.columnName(), organizzazioneId);
			separator = " and ";
		}
		if (enteId != null && organizzazioneId == null)
		{
			sql.append(separator).append(Common_Paesaggio_Email.ente_id.getCompleteName()).append(" = :")
					.append(Common_Paesaggio_Email.ente_id.columnName()).append(" and ")
					.append(Common_Paesaggio_Email.organizzazione_id.getCompleteName()).append(" IS NULL");
		...
		if (organizzazioneId != null && enteId != null)
		{
			sql.append(separator).append(Common_Paesaggio_Email.organizzazione_id.getCompleteName()).append(" = :")
					.append(Common_Paesaggio_Email.organizzazione_id.columnName()).append(" and ")
					.append(Common_Paesaggio_Email.ente_id.getCompleteName()).append(" = :")
