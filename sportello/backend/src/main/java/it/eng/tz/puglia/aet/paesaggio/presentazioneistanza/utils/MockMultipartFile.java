...
public class MockMultipartFile implements MultipartFile {
	...
	public MockMultipartFile(String name, /*String originalFilename,*/ String contentType, byte[] content) {
		...
		this.name = name;
		this.originalFilename = name; // (originalFilename != null ? originalFilename : "");
	...
	public MockMultipartFile(String name, /*String originalFilename,*/ String contentType, File file) throws IOException {

		this(name, /*originalFilename,*/ contentType, Files.toByteArray(file) /*new byte[(int) file.length()] *//*new FileInputStream(file)*/);
	}
	
	public MockMultipartFile(String name, File file) throws IOException {
		this(name, /*"",*/ null, file);
	}
