...
/**
 * Controller CRUD for table presentazione_istanza.ruolo_referente
 */
@Controller
@RequestMapping("/RuoloReferente")
public class RuoloReferenteController extends BaseRestController{

    /**
     * logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(RuoloReferenteController.class);
    /**
     * service
     */
    @Autowired
    private IRuoloReferenteService service;

    /**
     * select all
     */
    @GetMapping(value="/select.pjson", produces=MEDIA_TYPE)
    public ResponseEntity<BaseRestResponse<List<RuoloReferenteDTO>>> select(){
    ...
    public ResponseEntity<BaseRestResponse<RuoloReferenteDTO>> find(@RequestBody RuoloReferenteDTO pk){
    ...
    public ResponseEntity<BaseRestResponse<PaginatedList<RuoloReferenteDTO>>> search(@RequestBody RuoloReferenteSearch search){
    ...
    public ResponseEntity<BaseRestResponse<Long>> insert(@RequestBody RuoloReferenteDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> update(@RequestBody RuoloReferenteDTO dto){
    ...
    public ResponseEntity<BaseRestResponse<Integer>> delete(@RequestBody RuoloReferenteDTO dto){
