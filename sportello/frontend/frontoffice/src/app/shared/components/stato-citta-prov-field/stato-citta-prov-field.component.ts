...
import { FormGroup, NgFormSelectorWarning, Validators } from '@angular/forms';
import { ProvinciaService } from '../../services/provincia.service';
import { ComuneService } from '../../services/comune.service';
import { NazionalitaService } from '../../services/nazionalita.service';
...
export class StatoCittaProvFieldComponent implements OnInit {
  ...
  @Input() validateComuneEstero: boolean = true;
  @Input() label: string;
