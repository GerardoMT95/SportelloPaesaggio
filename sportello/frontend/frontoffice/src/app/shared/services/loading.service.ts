...
export class LoadingService {
  ...
  public loadingObservableCustomMessage: EventEmitter<string> = new EventEmitter();
  ...
  public emitLoadingCustomMessage(message:string){
    this.loadingObservableCustomMessage.emit(message);
}
