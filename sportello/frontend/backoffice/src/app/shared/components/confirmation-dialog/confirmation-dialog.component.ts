...
import { DialogModel, IButton } from 'src/app/core/models/dialog.model';
...
export class ConfirmationDialogComponent implements OnInit
{
  ...
  constructor(private serviceDialog: CustomDialogService, private router: Router) { }
...
export class DialogButtons {
  ...
  public static OK_CANCEL_CHIUDI: IButton[] = [
    ...
    { id: ButtonType.CANCEL_BUTTON, label: 'BUTTONS.CANCEL_BUTTON' },
    { id: ButtonType.OK_BUTTON, label: 'BUTTONS.OK_BUTTON' }
  ];
