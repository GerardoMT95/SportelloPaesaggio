import { TemplateDestinatarioDTO } from 'src/app/components/model/entity/admin.models';
...
export class TabellaIndirizziComponent
{
  ...
  /* @Input("addresses") set _addresses(a: Array<DestinatarioComunicazioneDTO|TemplateDestinatarioDTO>)
  {
    this.addresses = [];
    if(a && a.length)
    {
      if (typeof (a[0].pec) === "string") 
      {
        //Allora sono nel caso TemplateDestinatarioDTO
        this.addresses = this.convert(a as TemplateDestinatarioDTO[]);
      }
      else
      {
        //Allora sono nel caso DestinatarioComunicazioneDTO
        this.addresses = copyOf(a);
      }
    }
  } */
  @Input("addresses") public addresses: Array<DestinatarioComunicazioneDTO> = [];
  ...
  /* private convert(dest: TemplateDestinatarioDTO[]): DestinatarioComunicazioneDTO[]
  {
