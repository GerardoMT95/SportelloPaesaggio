 ...
 *         &lt;element ref="{http://protocolloWS.egov.rupar.puglia.it/protocollo}Segnatura"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ParametriEseguiProtocolloCifra")
public class ParametriEseguiProtocolloCifra {

    @XmlElement(name = "CredenzialiUtente", required = true)
    protected CredenzialiUtente credenzialiUtente;
    @XmlElement(name = "Segnatura", required = true)
