...
import it.eng.tz.puglia.servizi_esterni.remote.rowmapper.RubricaEnteRowMapper;
 ...
 */
@Repository
public class RubricaEnteBaseRepository  extends GenericCrudDao<RubricaEnteDTO, RubricaEnteSearch, Long>
{
