...
public class SegnaturaProtocollo {
     ...
     * r_puglia/ct_rupar_puglia/GG/MM/AAAA/0005395
     * r_puglia/AOO_145/14/01/2016/0000256
     */
    @Override
    public String toString() {
    	...
    	//rimosso codice registro su segnalazione http://jira.rsr.rupar.puglia.it/browse/ETI6-146
...
//    	}
    ...
    public static SegnaturaProtocollo fromProtocolloResponse(ProtocolloResponseBean res) {
    	SegnaturaProtocollo out=new SegnaturaProtocollo();
    	out.setCodiceAmministrazione(res.getCodiceAmministrazione());
    	out.setCodiceAOO(res.getCodiceAOO());
    	out.setCodiceRegistro(res.getCodiceRegistro());
    	out.setNumeroProtocollo(res.getNumeroProtocollo());
    	out.setDataRegistrazione(res.getDataRegistrazione());
    	return out;
    }
}
